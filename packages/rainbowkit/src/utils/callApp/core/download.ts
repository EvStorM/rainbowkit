 ...
 */
import { CallAppOptions, DownloadConfig, TargetInfo } from '../index';
...
export const allDownloadUrls = {
  ...
  [AppFlags.ZZSeeker]: {
    ...
    android_yyb:
      'https://sj.qq.com/myapp/detail.htm?apkName=com.huodao.hdphone',
  ...
  [AppFlags.ZZHunter]: {
    ...
    android_yyb:
      'https://sj.qq.com/myapp/detail.htm?apkName=com.zhuanzhuan.hunter',
  ...
  [AppFlags.WXMini]: {
    ...
    android_api:
      'https://dldir1.qq.com/weixin/android/weixin8011android1980.apk',
...
export const generateDownloadUrl = (instance: CallAppInstance): string => {
  ...
  const { channelId, deeplinkId, download, middleWareUrl } = options;
